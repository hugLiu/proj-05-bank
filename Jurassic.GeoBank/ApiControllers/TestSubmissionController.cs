...
namespace Jurassic.WebGeoBank.ApiControllers
{
    public class TestSubmissionController : ApiController
    {
        // GET api/<controller>
        [HttpGet]
        ...
        // POST api/<controller>
        [HttpPost]
        public async Task<Dictionary<string, string>> TestPost(int id = 0)
        {
